...
class PostListPage extends Component {
    ...
    handleThumbUpPost = (post, vote) => this.props.dispatch(thumbUpPostRequest(post, vote));
    handleThumbDownPost = (post, vote) => this.props.dispatch(thumbDownPostRequest(post, vote));
